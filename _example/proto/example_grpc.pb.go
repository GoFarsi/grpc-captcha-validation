...
func (c *greetingServiceClient) GreetingStream(ctx context.Context, opts ...grpc.CallOption) (GreetingService_GreetingStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetingService_ServiceDesc.Streams[0], GreetingService_GreetingStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &greetingServiceGreetingStreamClient{stream}
	return x, nil
}
...
type greetingServiceGreetingStreamClient struct {
	grpc.ClientStream
}

func (x *greetingServiceGreetingStreamClient) Send(m *GreetingRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetingServiceGreetingStreamClient) Recv() (*GreetingResponse, error) {
...
func (UnimplementedGreetingServiceServer) GreetingStream(GreetingService_GreetingStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method GreetingStream not implemented")
}
...
func _GreetingService_GreetingStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetingServiceServer).GreetingStream(&greetingServiceGreetingStreamServer{stream})
}
...
type greetingServiceGreetingStreamServer struct {
	grpc.ServerStream
}

func (x *greetingServiceGreetingStreamServer) Send(m *GreetingResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetingServiceGreetingStreamServer) Recv() (*GreetingRequest, error) {
